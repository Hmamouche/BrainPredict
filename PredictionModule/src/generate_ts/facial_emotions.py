...
if __name__ == '__main__':
	...
	detection_model_path = "%s/src/utils/face_classification/trained_models/detection_models/haarcascade_frontalface_default.xml"%maindir
	emotion_model_path = "%s/src/utils/face_classification/trained_models/fer2013_mini_XCEPTION.119-0.65.hdf5"%maindir
